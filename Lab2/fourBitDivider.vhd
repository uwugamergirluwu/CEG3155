...
architecture Structural of fourBitDivider is
    component fourBitDividerControl is
        port (
            CLK: in std_logic;
            RESETN: in std_logic;
            REM_N: in std_logic;
...
begin
    ...
    SRDividend: fourBitShiftRegister
        port map (
            CLK => CLK,
    ...
    SRDivisor: fourBitShiftRegister
        port map (
            CLK => CLK,
    ...
    SRRemainderLeft: fourBitShiftRegister
        port map (
            CLK => CLK,
    ...
    SRRemainderRight: fourBitShiftRegister
        port map (
            CLK => CLK,
            RESETN => RESETN and signalSRRemainderResetN,
    ...
    SRRemainderOutput: fourBitShiftRegister
        port map (
            CLK => CLK,
            RESETN => RESETN,
            MODE(1) => '0',
    ...
    SRQuotientOutput: fourBitShiftRegister
        port map (
            CLK => CLK,
            RESETN => RESETN,
            MODE(1) => '0',
